...
module.exports = function(options) {
  ...
  function execute (postUrl, req, res) {
    ...
    res.send(templates.form({
      ...
      wresult:        '<t:RequestSecurityTokenResponse Context="'+ escapedWctx + '" xmlns:t="http://schemas.xmlsoap.org/ws/2005/02/trust"><t:RequestedSecurityToken>' + escapedAssertion + '</t:RequestedSecurityToken></t:RequestSecurityTokenResponse>'
    }));
  }
